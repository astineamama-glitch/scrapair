...
const BusinessTransactionHistoryPage = () => {
      ...
      <div style={{ maxWidth: 1100, margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 16, flexWrap: 'wrap', marginBottom: 32 }}>
          <div>
            ...
            <p style={{ margin: '8px 0 0', color: C.textMid }}>View all completed pickups from recyclers for your waste materials.</p>
          </div>
          <button
            onClick={() => navigate(-1)}
            style={{
        ...
        {loading ? (
          ...
          >
            No completed pickups yet. Your completed transactions will appear here.
          </div>
        ) : (
            ...
            {filteredAndSorted.map((collection) => {
              ...
              return (
                <div
                  ...
                  onClick={() => navigate(`/business/collection/${collection.id}/${collection.transactionCode || 'unknown'}`)} 
                >
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr auto', gap: 20, alignItems: 'start' }}>
                    <div style={{ minWidth: 0 }}>
                      ...
                      >
                        ...
                        >
                          {collection.post?.title || `Pickup #${collection.id}`}
                        </h3>
                        <div
                          style={{
                            fontSize: 11,
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 8, minWidth: 150 }}>
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                          navigate(`/business/collection/${collection.id}/${collection.transactionCode || 'unknown'}`);
                        }}
                        style={{
                          padding: '10px 14px',
                          borderRadius: 8,
...
export default BusinessTransactionHistoryPage;
